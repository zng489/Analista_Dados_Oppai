...
with DAG(
        ...
        dag_id = 'bq_users_',
        description = 'bq_users_',
        start_date = datetime(2023, 11, 23),
        schedule_interval='@daily'
    ) as dag:
        start_task = DummyOperator(task_id='start_lnd', dag=dag)
        task1 = PythonOperator(task_id = 'bq_users_',python_callable = load_data_from_gcs_to_bq)
